...
class CompraAdapter(var listaCompra: List<Compra>, var listener: CompraAdapterListener):RecyclerView.Adapter<CompraAdapter.ItemViewHolder>() {
    ...
    // Responsável por encontrar os componentes dentro do layout (item_compra) e indicar que o
    ...
    // Vincula os componentes do layout (item_compra) a um dado/propriedade/atributo da lista

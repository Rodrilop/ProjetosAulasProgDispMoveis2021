...
class CadastroActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    lateinit var edtNomeTarefa: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSalvar.setOnClickListener(){
            val usuario = Tarefa(fotoTirada, edtNomeTarefa.text.toString(), edtDescricao.text.toString(), prioridade, perfil, swtUrgente.isChecked)
